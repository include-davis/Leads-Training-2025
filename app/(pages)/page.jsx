...
const days = [
  ...
  { day: 4, title: 'Task 4', description: 'Create a GCal Event and take in event details like title, date, time, etc. from frontend and send the data over to some internal api endpoint', url: '/task4' },
